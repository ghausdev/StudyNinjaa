...
const TutorList = () => {
    ...
    const handleBookSession = async () => {
        try {
            ...
            const endTime = new Date(Date.UTC(year, month - 1, day, endHour, endMinute));
    ...
    const filteredTutors = tutors
        .filter(tutor => {
            const matchesLevel = studyLevelFilter === 'all' || tutor.studyLevel === studyLevelFilter;
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                    ...
                                    <p><span className="font-medium">Experience:</span> {tutor.experience} years</p>
                                    <p><span className="font-medium">Rate:</span> ${tutor.hourlyRate}/hour</p>
                                    <p><span className="font-medium">Study Level:</span> {tutor.studyLevel}</p>
                                </div>
            ...
            {isBookingModalOpen && selectedTutor && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg p-6 max-w-2xl w-full">
                        <h2 className="text-xl font-semibold mb-4">Book Session with {selectedTutor.fullName}</h2>
                        <div className="space-y-4">
                            ...
                            {bookingData.selectedDay && (
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        {selectedTutor.availability[bookingData.selectedDay].map((timeSlot) => (
                                            <button
                                                key={timeSlot}
                                                onClick={() => setBookingData({
                                                    ...bookingData,
                            ...
                            <div className="flex justify-end space-x-3">
                                ...
                                <button
                                    ...
                                    disabled={!bookingData.selectedDay || !bookingData.selectedTime || !bookingData.purpose}
                                >
                                    Book Session
                                </button>
                            </div>
