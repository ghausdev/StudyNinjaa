...
const EssayUpload = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            uploadData.append('comments', formData.notes); // Assuming 'notes' is the comments field
            uploadData.append('file', file); // Ensure this matches the backend expectation
            if (markScheme) {
                uploadData.append('markingScheme', markScheme); // Ensure this matches the backend expectation
            }
            ...
            if (response?.message === "Essay uploaded successfully!") {
                ...
                setErrors({
                    submit: response?.message || 'Failed to upload essay. Please try again.'
                });
            }
        } catch (error) {
            setErrors({
    ...
    if (!isAuthenticated) {
        return <div className="text-center text-red-500">Please Login to upload the Essay</div>;
    }
                ...
                {loading && (
                    <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
                        <div className="bg-white p-6 rounded-lg shadow-xl text-center">
                            ...
                            <div className="text-gray-700 font-medium">Uploading Essay...</div>
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`mt-1 block w-full rounded-md shadow-sm ${errors.title ? 'border-red-300' : 'border-gray-300'
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`mt-1 block w-full rounded-md shadow-sm ${errors.subject ? 'border-red-300' : 'border-gray-300'
                                } focus:border-red-500 focus:ring-red-500`}
                        />
                    ...
                    <div>
                        <label htmlFor="studentRequest" className="block text-sm font-medium text-gray-700">
                            Request Type
                            <span className="text-red-500">*</span>
                        </label>
                        <select
                            ...
                            onChange={handleChange}
                            className={`mt-1 block w-full rounded-md shadow-sm ${errors.studentRequest ? 'border-red-300' : 'border-gray-300'
                                } focus:border-red-500 focus:ring-red-500`}
                        >
                            <option value="Feedback Only">Feedback Only</option>
                            <option value="Feedback and Model Answer">Feedback and Model Answer</option>
                        </select>
                        {errors.studentRequest && <p className="mt-1 text-sm text-red-600">{errors.studentRequest}</p>}
                    </div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className={`mt-1 block w-full rounded-md shadow-sm ${errors.academicLevel ? 'border-red-300' : 'border-gray-300'
                                } focus:border-red-500 focus:ring-red-500`}
                        >
                        ...
                        {errors.academicLevel && <p className="mt-1 text-sm text-red-600">{errors.academicLevel}</p>}
                    </div>
