    ...
    <div className="max-w-3xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-sm">
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-6">
          There was an issue processing your payment. Please contact support if
          this persists.
        </p>
        <div className="space-x-4">
          ...
          <button
            onClick={() => navigate("/tutor/support")}
...
export default TutorPaymentFailed;
